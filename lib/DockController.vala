...
namespace Plank {
  ...
  public class DockController : DockContainer {
    ...
    Gee.ArrayList<unowned DockItem> new_visible_items;
    ...
    public Gee.ArrayList<unowned DockItem> VisibleItems {
      get {
        visible_mutex.lock ();
        unowned var return_visible_items = visible_items;
        visible_mutex.unlock ();
        return return_visible_items;
      }
    }
    ...
    construct
    {
      ...
      new_visible_items = new Gee.ArrayList<unowned DockItem> ();
    ...
    protected override void update_visible_elements () {
      ...
      visible_mutex.lock ();
      visible_items.clear ();
      visible_items.add_all (new_visible_items);
      visible_mutex.unlock ();
    }
